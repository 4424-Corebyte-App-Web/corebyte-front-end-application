...
export default {
  name: "BatchManagementBottledStage",
  ...
  methods: {
    ...
    goToRegister() {
      this.$router.push("/batch-management/bottled/register");
    },
  },
};
</script>
        ...
        <div v-else class="batches-grid">
          ...
          >
            ...
            <div class="batch-details">
              ...
              <p>
                <strong>{{ $t("batch.tables.NLote") }}:</strong>
                {{ batch.NLote }}
              </p>
              <p>
                <strong>{{ $t("batch.tables.total") }}:</strong>
                {{ batch.total }}
              </p>
            </div>
          </div>
