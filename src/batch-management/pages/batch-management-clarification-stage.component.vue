...
export default {
  name: "BatchManagementClarificationStage",
  ...
  methods: {
    ...
    goToRegister() {
      this.$router.push("/batch-management/clarification/register");
    },
    goToUpdate() {
      this.$router.push("/batch-management/clarification/update");
    },
  },
};
</script>
  ...
  <div class="batch-overview-container">
    ...
    <div class="batch-summary">
      <div class="batch-summary-header">
        <h2>{{ $t("batch.clarification") }}</h2>
        <button @click="goToRegister" class="new-batch-button">
          <i class="pi pi-plus"></i> {{ $t("batch.texts.register") }}
        </button>
        <button @click="goToUpdate" class="new-batch-button">
          <i class="pi pi-plus"></i> {{ $t("batch.texts.update") }}
        </button>
      </div>
        ...
        <div v-else class="batches-grid">
          ...
          >
            ...
            <div class="batch-details">
              ...
              <p>
                <strong>{{ $t("batch.tables.amount") }}:</strong>
                {{ batch.amount }}
              </p>
            </div>
          </div>
