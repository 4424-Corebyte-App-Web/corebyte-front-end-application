    ...
    setup() {
      ...
      async function fetchBatches() {
        try {
          ...
          error.value = 'Error fetching batches: ' + (err.message || 'Failed to load batches');
      ...
      function navigateTo(stage) {
        ...
        const routeName = stageNames[stage];
        if (routeName) {
      ...
      const viewBatchDetails = (batchId) => {
        ...
        router.push(`/app/batch-management/fermentation?id=${batchId}`);
      };
