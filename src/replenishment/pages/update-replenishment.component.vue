  ...
  methods: {
    updateReplenishment() {
      this.replenishmentApiService
        .updateResource(this.replenishment)
        .then(() => {
          alert("Replenishment updated successfully.");
          // Reiniciar el formulario
          this.replenishment = new Replenishment({});
        })
        .catch((error) => {
          console.error("Error al actualizar el replenishment", error);
          alert("Hubo un error al actualizar el replenishment.");
        });
    },
  },
};
...
<template>
  <div class="form-container">
    <h2>Update Replenishment</h2>

    <form @submit.prevent="updateReplenishment">
