...
router.beforeEach((to, from, next) => {
    const publicPages = ["/login", "/register", "/recover-code", "/confirmation-code", "/password-recovered"];
    ...
    // Si está logueado y quiere ir a login o register, lo mandamos a su perfil
